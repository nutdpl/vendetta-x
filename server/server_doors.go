...
func (b *board) doors(s *term.Session, tok map[string]string, user *store.User) {
	for {
		...
		s.Print("  \x1b[1;33m 3  \x1b[1;31mRed Dragon        \x1b[1;30m\xfa a fantasy RPG -- slay the dragon\x1b[0m\r\n")
		...
		if len(ext) == 0 {
			s.Print("\r\n\x1b[1;30m  DOSBox-hosted doors (classic DOS games) are configured by the sysop.\x1b[0m\r\n")
		} else {
